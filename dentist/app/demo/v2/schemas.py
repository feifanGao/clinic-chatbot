...
definitions = {'definitions': {'Dentist': {'type': 'object', 'properties': {'name': {'type': 'string', 'example': 'John'}, 'location': {'type': 'string', 'example': "Sydney Children's Hospital"}, 'specialization': {'type': 'string', 'example': 'Paediatric Dentistry'}}}}, 'parameters': {}}

validators = {
}

filters = {
    ('dentist', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Dentist'}}}, 404: {'headers': None, 'schema': None}},
    ('dentist_name', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Dentist'}}}, 404: {'headers': None, 'schema': None}},
}
