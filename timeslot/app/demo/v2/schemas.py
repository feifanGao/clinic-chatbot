...
definitions = {'definitions': {'Timeslot': {'type': 'object', 'properties': {'id': {'type': 'integer', 'example': 1}, 'dentist': {'type': 'string', 'example': 'Alice James'}, 'date': {'type': 'string', 'example': '11.11'}, 'time': {'type': 'number', 'description': 'appointment starting time', 'example': 15}, 'status': {'type': 'string', 'description': 'Timeslot status', 'enum': ['available', 'unavailable']}}}}, 'parameters': {}}

validators = {
    ('timeslot', 'GET'): {'args': {'required': ['dentist'], 'properties': {'dentist': {'description': 'name of dentist that need to search', 'type': 'string'}}}},
    ('timeslot', 'PATCH'): {'args': {'required': ['dentist', 'time'], 'properties': {'dentist': {'description': 'name of the dentist patient want to choose', 'type': 'string'}, 'time': {'description': 'start time of the booking', 'type': 'integer'}}}},
}

filters = {
    ('timeslot', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Timeslot'}}}, 404: {'headers': None, 'schema': None}},
    ('timeslot', 'PATCH'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Timeslot'}}}, 404: {'headers': None, 'schema': None}},
}
