...
validators = {
    ('ask', 'GET'): {'args': {'required': ['expression'], 'properties': {'expression': {'description': 'user input e.g. Show me all dentists available', 'type': 'string'}}}},
}

filters = {
    ('ask', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string'}}}}, 404: {'headers': None, 'schema': None}},
}
